  ...
  return (
    <section className="relative px-4 py-12 md:py-20 max-w-7xl mx-auto overflow-hidden">
      ...
      <div className="text-center mb-12 md:mb-16 animate-fade-in-up">
        ...
        <form onSubmit={handleSubmit} className="max-w-2xl md:max-w-3xl mx-auto mb-10 md:mb-12 px-4">
            ...
            <div className="relative flex flex-col md:flex-row items-center bg-white rounded-xl md:rounded-2xl shadow-soft border-gradient overflow-hidden">
              <div className="flex items-center w-full px-4 md:px-6 py-3 md:py-4">
                ...
                <Input
                  ...
                  className="border-0 text-base md:text-lg bg-transparent focus-visible:ring-0 focus-visible:ring-offset-0 placeholder:text-gray-400 flex-1"
                />
              </div>
              <Button 
                type="submit" 
                className="gradient-bg hover:opacity-90 transition-all duration-300 text-white font-semibold px-6 md:px-8 py-3 md:py-4 w-full md:w-auto rounded-t-none md:rounded-t-2xl md:rounded-l-none md:rounded-r-2xl shadow-soft-hover"
              >
